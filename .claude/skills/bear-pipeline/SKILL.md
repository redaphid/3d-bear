...
| 5 keychain | `python tools/keychain.py print-ready/<bear>.stl --out print-ready/keychain-<bear>-32mm.stl --scale 0.2 --views` (loop on the head, manifold union, solid print) | 32 mm bear with a 4.5 mm loop |
