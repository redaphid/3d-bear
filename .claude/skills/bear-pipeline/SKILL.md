...
| 4 hollow | `python tools/hollow.py print-ready/<bear>.stl --out print-ready/totem-<bear>-hollow-2mm.stl --wall 2.0 --pitch 0.4 --height 160 --views` (uniform-wall shell, base open; slice as a normal solid) | the totem STL, ~100 g |
