...
| `keychain-bear-r4b-TRELLIS-32mm-corded-nfc.stl` | **the keychain with an NFC pocket**: as above plus a 10.5 x 0.8 mm recess in the underside of the plinth for an NTAG215 10 mm sticker (1.5 mm riser added, 33.5 mm tall); 2.7 mm of wall around the pocket | 19 x 17 mm | — | print SOLID standing up, no supports; the pocket floor is a 10.5 mm bridge on layer 4, hidden by the sticker. Sections in `preview-keychain-r4b-TRELLIS-nfc-sections.png` |
