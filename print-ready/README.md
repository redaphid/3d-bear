...
|---|---|---|---|---|
| `keychain-bear-r4b-TRELLIS-32mm-corded.stl` | **keychain, for a 1 mm stretch cord**: the bear at 20 % (32 mm) with a 3 mm tunnel bored through the raised arms — no added loop | 19 x 17 mm | 4.4 % | **RECOMMENDED.** ~55 mm2 of material around the bore, roughly 4x a 3 mm ring. Print solid, hole prints slightly undersized so 3 mm passes 1 mm cord easily |
