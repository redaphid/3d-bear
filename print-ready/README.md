...
| `totem-bear-r4b-TRELLIS-240mm-hollow-2.5mm.stl` | the totem at **240 mm** (fills the Centauri's 256 mm cube with margin), **high-detail build**: 0.3 mm voxel pitch, 250k-face outer skin, minimal smoothing, 2.5 mm wall, base opening 133 x 129 mm | 143 x 129 mm | 9.9 % incl. cavity ceilings | ~194 cm3, about 240 g; eyes, teeth, fur ridges and claws all survive (see the close-up preview) |
